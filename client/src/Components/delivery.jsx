        ...
        <section>
          <section className="sticky">
            <div className="max-w-lg px-4 sm:pt-24 pt-12 sm:pb-8 mx-auto text-left md:max-w-none md:text-center">
              ...
              <h1 className="font-extrabold leading-10 tracking-tight md:text-left text-[#201515] text-center sm:leading-none text-5xl sm:text-9xl">
                      ...
                      <div className="max-w-xl text-center lg:text-left">
                        <div>
                          ...
                          <p className="max-w-xl mt-4 text-base tracking-tight text-gray-600">
                            ...
                            interesting, and showcase your brand's personality.
