...
const Process = () => {
  ...
  return (
    ...
    <section className="sticky top-0">
      <motion.div
        className="min-w-full sm:pt-24 pt-12 sm:pb-8 mx-auto text-center"
        initial="hidden"
        animate="visible"
      >
      ...
      <div className="max-w-full px-4 pb-24 mx-auto text-center">
    ...
    <div className="text-left">
      <Slider {...sliderSettings}>
        <div className="relative flex items-center w-full slide-0">
          <div className="relative items-center w-full px-5 mx-auto md:px-12 lg:px-16 max-w-full">
